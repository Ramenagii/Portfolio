const projects = [
  {
    ...
    image: "/SCAM.jpg",
    blurb:
      "Notes, flashcards, activity flow — interface that feels less like a raw school requirement.",
    summary:
  ...
  },
  {
    ...
    type: "This website",
    image: "/Pwebsite.jpg",
    blurb: "Quieter one-page rebuild that puts projects and real skill level first.",
    summary:
  ...
  },
  {
    ...
    type: "Learning tool",
    image: "/DSA.jpg",
    blurb: "Algorithm steps made noticeable, not just animated.",
    summary:
...
export default function Portfolio() {
  return (
    <section id="work">
      <div className="project-strip reveal">
        <div className="page-shell project-strip-grid">
          {projects.map((project, index) => (
            <a className="project-strip-card" href={`#project-${project.id}`} key={project.id}>
              <p className="eyebrow">
